...
import { changePostion, fetchCompanyInfo, fetchEmployeeData } from '../../api/api';
...
function ChangePostion() {
  ...
  useEffect(() => {
    fetchCompanyInfo().then(res=> setdesignations(res?.data?.designations))
  ...
  const formik = useFormik({
    ...
    return (
      ...
      <div className='separation'>
        ...
        <h5 className='font-semibold metal m-auto pb-2'>Update Position</h5>           
            <div className='mb-4'>
