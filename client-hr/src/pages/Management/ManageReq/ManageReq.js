...
import {getLeaveRequest, getLearningRequest} from "../../../api/api"
import { initial, fetchRequest, fetchLearning } from '../../../redux/requests/requestSlice'
...
function ManageReq() {
    ...
    const {reqData, learnings} = useSelector(state=> state.requests)
    let isloading=false
    if(!reqData.length && !learnings.length) isloading=true
