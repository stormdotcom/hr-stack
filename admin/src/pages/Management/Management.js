    ...
    return (
        <div>
            <div className='selfService'>
                ...
                <div onClick={()=> {navigate("/management/assets")}} className='button-4 sm:w-full xs:w-full md:w-5/12'> <MdAddToQueue className='mx-auto text-4xl text-fourth'/><p> Add Assets </p></div>
